...
from image_io import import_image, export_image, save_np_array_as_tif
...
filtered_boundary_map, mask = filtered_boundary_map(boundary_map, rescaled_image, filter_name)
save_np_array_as_tif(output_path, mask)
